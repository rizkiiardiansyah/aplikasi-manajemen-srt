<?php
    ...
    if(empty($_SESSION['admin'])){
        ...
        $query = mysqli_query($config, "SELECT * FROM tbl_surat_keluar WHERE no_agenda LIKE '%$cari%' OR tujuan LIKE '%$cari%' OR no_surat LIKE '%$cari%' OR isi LIKE '%$cari%' 
        OR kode LIKE '%$cari%' OR tgl_surat LIKE '%$cari%' OR tgl_catat LIKE '%$cari%' OR keterangan LIKE '%$cari%'
