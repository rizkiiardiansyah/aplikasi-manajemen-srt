          ...
          <div class="row">
            ...
            <div class="box box-info collapsed-box box-solid">
                <div class="box-header with-border">
                  <h3 class="box-title">Tampilkan Detail Surat Masuk</h3>
...
<?php            
       ...
       ?>
              ...
              <button onclick="window.history.back()" class="btn btn-danger"><span class="glyphicon glyphicon-circle-arrow-left"></span> Kembali</button>
...
if(empty($row['file'])){
                            ...
                            if(in_array($eks, $ekstensi) == true){
                                echo '
                                <div class="col-md-7">     
                                <img class="gbr" data-caption="'.date('d M Y', strtotime($row['tgl_diterima'])).'" src="./upload/surat_masuk/'.$row['file'].'"/>
                                ...
                                if(in_array($eks, $ekstensi2) == true){
                                  ...
                                  <br/>
                                  <p class="card-text">File lampiran surat masuk ini bertipe <strong>document</strong>, silakan klik link dibawah ini untuk melihat file lampiran tersebut.<br/>
                                  ...
                                  <br/>
                                  <p class="card-text">
                                    File lampiran surat masuk ini bertipe <strong>PDF</strong>, silakan klik link dibawah ini untuk melihat file lampiran tersebut.
                                                            <strong>Lihat file :</strong> <a class="blue-text" href="./upload/surat_masuk/'.$row['file'].'" target="_blank">'.$row['file'].'</a>
</p>                               
                </div>
