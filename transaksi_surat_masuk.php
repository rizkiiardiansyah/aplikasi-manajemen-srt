<?php
    ...
    if(empty($_SESSION['admin'])){
        ...
        $query = mysqli_query($config, "SELECT * FROM tbl_surat_masuk WHERE no_agenda LIKE '%$cari%' OR no_surat LIKE '%$cari%' OR asal_surat LIKE '%$cari%' OR isi LIKE '%$cari%' 
        OR kode LIKE '%$cari%' OR indeks LIKE '%$cari%' OR tgl_surat LIKE '%$cari%' OR tgl_diterima LIKE '%$cari%' OR keterangan LIKE '%$cari%' ORDER by id_surat DESC LIMIT $curr, $limit");
